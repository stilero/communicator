...
class TinyUrl extends Communicator{
    private $_longUrl;
    public $url;
    ...
    public function shorten(){
        $encodedLongUrl = $this->_longUrl;
        $post = array('url' => $encodedLongUrl);
        $this->setPostVars($post);
        $this->setUrl($this->_config['tinyUrlApi']);
        $this->query();
